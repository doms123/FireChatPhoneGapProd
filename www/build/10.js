...
var ChatPage = (function () {
    ...
    ChatPage.prototype.getUsers = function () {
        var _this = this;
        this.chatProvider.getUsers().subscribe(function (users) {
            users.forEach(function (data, index) {
                if (data.$key == _this.loggedUserId) {
    ...
    ChatPage.prototype.getLoggedUserId = function () {
        this.loggedUserId = this.chatProvider.getLoggedUserId();
    };
    ChatPage.prototype.logoutBtn = function () {
        this.authProvider.loggedOut();
        this.storage.clear();
        this.app.getRootNav().setRoot('LandingPage');
    };
    ChatPage.prototype.chatBox = function (user) {
        var chatRoom = this.chatProvider.chatMember(user.$key, user.displayName);
